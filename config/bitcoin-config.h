...
/* the conf of application */
#define BLOCKCHAIN_CONF "DaliChain.conf"

/* the directory of data */
#define BLOCKCHAIN_DATADIR "daliChain"

/* the block chain name */
#define BLOCKCHAIN_NAME "DaliChain"

/* The domain of organization abbreviation */
#define BLOCKCHAIN_ORG_DOMAIN "https://www.dalichain.io"

/* The developers of company */
#define BLOCKCHAIN_ORG_FULLNAME "DALICHAIN FOUNDATION PTE. LTD."

/* The organization abbreviation */
#define BLOCKCHAIN_ORG_NAME "DaliChain"

/* the pid of application */
#define BLOCKCHAIN_PID "DaliChain.pid"

/* the uri prefix. such as: http */
#define BLOCKCHAIN_URI_PREFIX "dalichain"
...
/* The number of check contract rule height. */
#define CONTRACT_CHECK_HEIGHT 759247

/* The number of contract state new version height. */
#define CONTRACT_STATE_VERSION_HEIGHT 759247
...
/* The number of block chain token get all token by coinbase */
#define MAINCOIN_BASE_NUM 10

/* The max money of block chain token. */
#define MAINCOIN_MAX 210000000

/* The name of the block chain token */
#define MAINCOIN_NAME "DALI"

/* The amount of token by coinbase */
#define MAINCOIN_PER 21000000

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "https://github.com/bitcoin/bitcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DaliChain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DaliChain Core 0.14.1"
...
/* the name of Qt application */
#define QAPP_GUI_NAME "DaliChain-Qt"

/* the name of Qt application in testnet */
#define QAPP_GUI_NAME_TESTNET "DaliChain-Qt-testnet"
...
/* The simple name of block chain token. */
#define TOKEN_NAME "Dali"
...
/* Define to 1 to enable attach file functions */
/* #undef __ATTACHFILE__ */

/* Define to 1 to enable wallet functions */
#define __SSL_MINING__ 1

/* Define to 1 to enable wallet functions */
/* #undef __SSL_SOCKET__ */
